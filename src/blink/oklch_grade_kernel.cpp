kernel OKLCHGrade : ImageComputationKernel<ePixelWise>
{
  ...
  float3 oklab_to_xyz(float3 lab)
  {
    ...
    float l_ = 1.0f * lab.x + 0.3963377773761749f * lab.y +  0.2158037573099136f * lab.z;
    float m_ = 1.0f * lab.x + -0.1055613458156586f * lab.y + -0.0638541728258133f * lab.z;
    float s_ = 1.0f * lab.x + -0.0894841775298119f * lab.y + -1.2914855480194092f * lab.z;
